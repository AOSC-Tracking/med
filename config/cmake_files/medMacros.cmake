...
MACRO(MED_FIND_HDF5)
    ...
    ##
    IF (NOT HDF_VERSION_MAJOR_REF EQUAL 1 OR NOT HDF_VERSION_MINOR_REF EQUAL 14 OR NOT HDF_VERSION_RELEASE_REF GREATER 0)
        MESSAGE(FATAL_ERROR "HDF5 version is ${HDF_VERSION_REF}. Only versions >= 1.14.0 are supported.")
    ENDIF()
    ##
    ##
